function printTravel() {
    ...
    window.alert("Em sua viagem para " + viagem + " com a distância de " + dist + " quilometros foram gastos " + lit +" litros de combustível! Ao final da viagem você teve uma autonomia de " + autonomia + "Km/L, o valor gasto por KM foi de R$" + (valorLitro/autonomia).toFixed(2));
}
